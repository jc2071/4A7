...
for height = heights
    ...
    co2_masses(index) = mass_co2*co2im;
    nox_masses(index) = mass_nox*noxim;
...
plot(heights,nox_masses/(flight_range*pmax) +co2_masses/(flight_range*pmax) ,'-' ,'color','b','DisplayName', 'sum','linewidth',2)
