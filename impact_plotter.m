...
ylabel('NO_x GWP')
set(gca,'YColor','k');
plot(0:1:15,[-7.1;-7.1;-7.1;-4.3;-1.5;6.5;14.5;37.5;60.5;64.7;68.9;57.7;46.5;25.6;4.6;0.6],'-x','Linewidth',1,'DisplayName','Raw NO_x GWP data','color','r');
yyaxis right
plot(altitudes,co2,'--','color','g','Linewidth',1.5,'DisplayName','CO_2 GWP')
ylabel('CO_2 GWP')
set(gca,'YColor','k');
box on
xlabel('Altitude (km)')
